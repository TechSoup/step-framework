...
[![Framework Version](https://img.shields.io/badge/framework-v0.1.0--alpha-orange)](CHANGELOG)
[![Maintained by TechSoup](https://img.shields.io/badge/maintained%20by-TechSoup%20Global%20Network-blueviolet)](https://techsoup.org)

**[View on GitHub](https://github.com/TechSoup/step-framework)** · **[Learn more at TechSoup](https://step.techsoup.org)** · **[Support STEP](https://www.every.org/techsoup)**
...
**This repo is the framework specification itself** — the criteria, scoring rubric, and guidance documents that define the standard.
...
| I want to… | Go to |
|---|---|
| Understand the full framework | [Framework Overview](docs/overview) |
| Browse assessment criteria by domain | [Assessment Domains](domains/) |
| See how tiers work | [Tiered Framework Design](docs/tiered-framework) |
| Contribute or propose changes | [Contributing Guide](CONTRIBUTING) |
...
*Framework content is licensed under [CC BY-SA 4.0](LICENSE). Maintained by [TechSoup Global Network](https://techsoup.org).*
