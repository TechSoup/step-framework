...
We as contributors and maintainers of the STEP Framework pledge to make
...
- Focusing on what is best not just for individuals but for the overall community
  and the civil society organizations this framework serves
...
Issues, Pull Requests, RFC discussions, and any other forum where community
members represent this project.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers at **step-framework@techsoup.org**.
